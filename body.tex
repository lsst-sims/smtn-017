...
{\bf Conclusions: The v2.1 baseline is a very minor change over v2.0, adding the Virgo cluster to the WFD footprint which slightly lowers the median coadded depth.}
...
\caption{The SNe and astrometry metrics for the various presto runs. \label{fig:presto_metics} }
\end{figure}
...
xxx--Varying the amount of time spent in the plane
...
local\_gals:  Observing local galaxies to extra depth. 
